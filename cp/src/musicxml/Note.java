...
//    }
	...
	public String toString() {
		return "Note [id=" + id + ", measure=" + measure + ", startTime=" + startTime + ", duration=" + duration
				+ ", pitch=" + pitch + ", voice=" + voice + ", accidental=" + accidental + ", accidentalInt="
				+ accidentalInt + ", counter=" + counter + ", midiPitch=" + midiPitch + ", octave=" + octave
				+ ", staff=" + staff + ", referenceNoteID=" + referenceNoteID + ", referenceChange=" + referenceChange
