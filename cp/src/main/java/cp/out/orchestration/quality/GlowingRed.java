...
import cp.out.instrument.woodwinds.Oboe1;
...
public class GlowingRed extends OrchestralQuality{
	...
	public GlowingRed() {
		...
		instruments = Stream.of(
				...
				new Oboe1(new InstrumentRegister(58, 67)),
				new FrenchHorn1(new InstrumentRegister(68, 79)),
				new Trumpet1(new InstrumentRegister(64, 70)),
				new Trombone1(new InstrumentRegister(53, 64)),
