...
@Aspect
@Component
public class FourVoiceCompositionDependingHarmony extends CompositionDependingHarmony {

    @AfterReturning(pointcut="execution(* cp..*FourVoiceComposition.*(..))", returning="melodyBlocks")
