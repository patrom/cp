...
public abstract class AbstractProvidder {
    ...
    protected List<CpMelody> getAtonalMelodies(){
        ...
        notes.add(note().pos(DurationConstants.EIGHT).pc(0).len(DurationConstants.SIXTEENTH).build());
        notes.add(note().pos(DurationConstants.EIGHT + DurationConstants.SIXTEENTH).pc(1).len(DurationConstants.SIXTEENTH).build());
        notes.add(note().pos(DurationConstants.QUARTER).pc(5).len(DurationConstants.EIGHT + DurationConstants.SIXTEENTH).build());
        notes.add(note().pos(DurationConstants.QUARTER + DurationConstants.EIGHT + DurationConstants.SIXTEENTH).pc(4).len(DurationConstants.SIXTEENTH).build());
        ...
        notes.add(note().pos(DurationConstants.SIXTEENTH).pc(1).len(DurationConstants.SIXTEENTH).build());
        notes.add(note().pos(DurationConstants.EIGHT).pc(3).len(DurationConstants.EIGHT).build());
